...
export const PATHS = {
  ...
  TEACHER_ONBOARDING_WIZARD: "/teacher/onboarding",
  TEACHER_INTERVIEW_ROOM: "/teacher/interview-room/:interviewId",
  ADMIN_TEACHER_VERIFICATION: "/admin/teacher-verification",
  ADMIN_PAYOUTS_MANAGER: "/admin/payouts-manager",
