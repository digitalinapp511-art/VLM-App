...
const TeacherRegistration: React.FC = () => {
  ...
  return (
    <div className={cn("min-h-screen flex items-center justify-center p-4 sm:p-6", bgCss)}>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className={cn(
          "w-full max-w-[380px] p-4 sm:p-5 rounded-[32px] border border-white/10",
      ...
      >
        ...
        <section className="text-center px-2 mb-3 sm:mb-6 mt-1 sm:mt-0">
